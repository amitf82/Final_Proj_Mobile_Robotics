...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sticky_fingers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/ros_ws/src/learning_ros_external_packages/sticky_fingers/${idir}'.  Ask the maintainer 'Tom <tes77@case.edu>' to fix it.")
    endif()
