...
(cl:defmethod cl:initialize-instance :after ((m <path-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'path-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab7alpha-srv:<path-request> is deprecated: use lab7alpha-srv:path-request instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <path-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab7alpha-srv:path-val is deprecated.  Use lab7alpha-srv:path instead.")
  (path m))
...
(cl:defmethod cl:initialize-instance :after ((m <path-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'path-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab7alpha-srv:<path-response> is deprecated: use lab7alpha-srv:path-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <path-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab7alpha-srv:status-val is deprecated.  Use lab7alpha-srv:status instead.")
  (status m))
