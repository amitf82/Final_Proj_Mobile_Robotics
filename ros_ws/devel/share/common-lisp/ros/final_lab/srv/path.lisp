...
(cl:defmethod cl:initialize-instance :after ((m <path-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'path-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name final_lab-srv:<path-request> is deprecated: use final_lab-srv:path-request instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <path-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader final_lab-srv:path-val is deprecated.  Use final_lab-srv:path instead.")
  (path m))
...
(cl:defmethod cl:initialize-instance :after ((m <path-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'path-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name final_lab-srv:<path-response> is deprecated: use final_lab-srv:path-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <path-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader final_lab-srv:status-val is deprecated.  Use final_lab-srv:status instead.")
  (status m))
