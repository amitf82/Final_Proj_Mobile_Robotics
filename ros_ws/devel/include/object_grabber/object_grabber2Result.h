...
struct object_grabber2Result_
{
  ...
  _des_flange_pose_stamped_wrt_torso_type des_flange_pose_stamped_wrt_torso;
    ...
    enum { SUCCESS = 0 };
     ...
     enum { OBJECT_GRABBER_BUSY = 7 };
     enum { OBJECT_GRABBER_CANCELLED = 8 };
     enum { FAILED_CANNOT_REACH_DROPOFF_POSE = 9 };
     enum { FAILED_CANNOT_REACH_DROPOFF_APPROACH = 10 };
     enum { FAILED_CANNOT_REACH_POSE_CARTESIAN_MOVE = 11 };
     enum { FAILED_CANNOT_REACH_JSPACE_MOVE = 12 };
     enum { FAILED_CANNOT_MOVE_CARTESIAN_FINE = 13 };
     enum { FAILED_CANNOT_MOVE_TO_PRE_POSE = 14 };
     enum { ACTION_CODE_UNKNOWN = 15 };
     enum { GRIPPER_IS_OPEN = 16 };
     enum { GRIPPER_IS_CLOSED = 17 };
     enum { GRIPPER_FAILURE = 18 };
     enum { PENDING = 19 };
     enum { OBJECT_DROPPED_OFF = 20 };
