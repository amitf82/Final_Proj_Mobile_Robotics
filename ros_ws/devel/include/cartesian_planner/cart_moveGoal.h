...
struct cart_moveGoal_
{
  ...
  _time_scale_stretch_factor_type time_scale_stretch_factor;
    ...
    enum { ARM_TEST_MODE = 0u };
     ...
     enum { GET_TOOL_POSE = 5u };
     enum { GET_Q_DATA = 7u };
     enum { PLAN_PATH_CURRENT_TO_WAITING_POSE = 20u };
     enum { PLAN_JSPACE_PATH_CURRENT_TO_CART_GRIPPER_POSE = 21u };
     enum { PLAN_PATH_CURRENT_TO_GOAL_GRIPPER_POSE = 22u };
     enum { PLAN_FINE_PATH_CURRENT_TO_GOAL_GRIPPER_POSE = 23u };
     enum { PLAN_PATH_CURRENT_TO_GOAL_DP_XYZ = 24u };
     enum { PLAN_JSPACE_PATH_CURRENT_TO_QGOAL = 25u };
     enum { TIME_RESCALE_PLANNED_TRAJECTORY = 40u };
     enum { REFINE_PLANNED_TRAJECTORY = 41u };
     enum { EXECUTE_PLANNED_PATH = 100u };
...
struct MD5Sum< ::cartesian_planner::cart_moveGoal_<ContainerAllocator> >
{
  ...
  {
    return "49508cd39a7773c727e404f80a5d50c8";
  }

  static const char* value(const ::cartesian_planner::cart_moveGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x49508cd39a7773c7ULL;
  static const uint64_t static_value2 = 0x27e404f80a5d50c8ULL;
};
