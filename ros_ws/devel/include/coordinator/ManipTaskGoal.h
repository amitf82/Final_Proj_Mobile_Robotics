...
struct ManipTaskGoal_
{
  ...
  _perception_source_type perception_source;
    ...
    enum { PCL_VISION = 1 };
     enum { BLIND_MANIP = 2 };
     enum { GET_PICKUP_POSE = 1 };
     enum { WAIT_FOR_FINDER = 101 };
     enum { FIND_TABLE_SURFACE = 2 };
     enum { WAIT_FIND_TABLE_SURFACE = 102 };
     enum { GRAB_OBJECT = 3 };
     enum { WAIT_FOR_GRAB_OBJECT = 103 };
     enum { DROPOFF_OBJECT = 4 };
     enum { WAIT_FOR_DROPOFF_OBJECT = 104 };
     enum { STRADDLE_OBJECT = 8 };
     enum { WAIT_FOR_STRADDLE_OBJECT = 108 };
     enum { CART_MOVE_TO_GRIPPER_POSE = 9 };
     enum { WAIT_FOR_CART_MOVE = 109 };
     enum { NO_CURRENT_TASK = 6 };
     enum { MOVE_TO_PRE_POSE = 7 };
     enum { WAIT_FOR_MOVE_TO_PREPOSE = 107 };
     enum { WAIT_FOR_MOVE = 107 };
     enum { ABORT = 666 };
