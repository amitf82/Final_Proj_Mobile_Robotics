...
get_filename_component(_filename "/home/user/ros_ws/src/Pan_Xie_don't_modify/Part_1/example_ros_service/srv/ExampleServiceMsg.srv" NAME_WE)
add_custom_target(_example_ros_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "example_ros_service" "/home/user/ros_ws/src/Pan_Xie_don't_modify/Part_1/example_ros_service/srv/ExampleServiceMsg.srv" ""
)

get_filename_component(_filename "/home/user/ros_ws/src/Pan_Xie_don't_modify/Part_1/example_ros_service/srv/PathSrv.srv" NAME_WE)
add_custom_target(_example_ros_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "example_ros_service" "/home/user/ros_ws/src/Pan_Xie_don't_modify/Part_1/example_ros_service/srv/PathSrv.srv" "geometry_msgs/Point:std_msgs/Header:geometry_msgs/Quaternion:geometry_msgs/PoseStamped:nav_msgs/Path:geometry_msgs/Pose"
)
