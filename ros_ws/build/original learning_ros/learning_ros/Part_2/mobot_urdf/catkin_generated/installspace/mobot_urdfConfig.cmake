...
if("FALSE" STREQUAL "TRUE")
  set(mobot_urdf_SOURCE_PREFIX /home/user/ros_ws/src/original learning_ros/learning_ros/Part_2/mobot_urdf)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mobot_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/ros_ws/install/${idir}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
    endif()
