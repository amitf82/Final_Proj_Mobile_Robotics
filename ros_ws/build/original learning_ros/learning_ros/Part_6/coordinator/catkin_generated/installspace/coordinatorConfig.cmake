...
if("FALSE" STREQUAL "TRUE")
  set(coordinator_SOURCE_PREFIX /home/user/ros_ws/src/original learning_ros/learning_ros/Part_6/coordinator)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'coordinator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/ros_ws/install/${idir}'.  Ask the maintainer 'wyatt <wyatt@todo.todo>' to fix it.")
    endif()
