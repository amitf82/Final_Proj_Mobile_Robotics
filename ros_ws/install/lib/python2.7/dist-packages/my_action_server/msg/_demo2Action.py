...
"""autogenerated by genpy from my_action_server/demo2Action.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import my_action_server.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class demo2Action(genpy.Message):
  _md5sum = "13d251e5eb7544d1098ca38505bd0b29"
  _type = "my_action_server/demo2Action"
...
"""
  ...
  _slot_types = ['my_action_server/demo2ActionGoal','my_action_server/demo2ActionResult','my_action_server/demo2ActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(demo2Action, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = my_action_server.msg.demo2ActionGoal()
      if self.action_result is None:
        self.action_result = my_action_server.msg.demo2ActionResult()
      if self.action_feedback is None:
        self.action_feedback = my_action_server.msg.demo2ActionFeedback()
    else:
      self.action_goal = my_action_server.msg.demo2ActionGoal()
      self.action_result = my_action_server.msg.demo2ActionResult()
      self.action_feedback = my_action_server.msg.demo2ActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_5i3I.pack(_x.action_goal.goal.input, _x.action_goal.goal.turn, _x.action_goal.goal.howLong, _x.action_goal.goal.finished, _x.action_goal.goal.halt, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i3I.pack(_x.action_result.result.output, _x.action_result.result.goal_stamp, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.input, _x.action_goal.goal.turn, _x.action_goal.goal.howLong, _x.action_goal.goal.finished, _x.action_goal.goal.halt, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_5i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.output, _x.action_result.result.goal_stamp, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_2i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
