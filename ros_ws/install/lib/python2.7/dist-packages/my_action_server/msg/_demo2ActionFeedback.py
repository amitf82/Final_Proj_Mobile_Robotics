...
"""autogenerated by genpy from my_action_server/demo2ActionFeedback.msg. Do not edit."""
import sys
...
class demo2ActionFeedback(genpy.Message):
  _md5sum = "5a6929cb3514eabf286ff2717ef7a5a4"
  _type = "my_action_server/demo2ActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_action_server/demo2Feedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(demo2ActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = my_action_server.msg.demo2Feedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = my_action_server.msg.demo2Feedback()
