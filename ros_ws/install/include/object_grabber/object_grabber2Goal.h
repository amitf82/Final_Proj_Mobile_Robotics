...
struct object_grabber2Goal_
{
  ...
  _desired_frame_type desired_frame;
    ...
    enum { UPRIGHT_CYLINDER = 1 };
     enum { GRAB_UPRIGHT_CYLINDER = 1 };
     enum { TOY_BLOCK = 2 };
     enum { GRAB_TOY_BLOCK = 2 };
     enum { GRAB_W_TOOL_Z_APPROACH = 2 };
     enum { PLACE_UPRIGHT_CYLINDER = 3 };
     enum { PLACE_TOY_BLOCK = 4 };
     enum { DROPOFF_ALONG_TOOL_Z = 4 };
     enum { MOVE_FLANGE_TO = 5 };
     enum { FINE_MOVE_FLANGE_TO = 6 };
     enum { MOVE_TO_PRE_POSE = 7 };
     enum { JSPACE_MOVE_FLANGE_TO = 8 };
     enum { CLOSE_GRIPPER = 100 };
     enum { OPEN_GRIPPER = 101 };
