...
struct object_grabberGoal_
{
  ...
  _gripper_test_params_type gripper_test_params;
    ...
    enum { TEST_CODE = 0 };
     enum { MOVE_TO_WAITING_POSE = 1 };
     enum { PLAN_MOVE_TO_GRASP_POSE = 2 };
     enum { PLAN_MOVE_FINE_TO_GRASP_POSE = 3 };
     enum { PLAN_MOVE_OBJECT_JSPACE = 4 };
     enum { PLAN_MOVE_OBJECT_CSPACE = 5 };
     enum { PLAN_MOVE_FINE_OBJECT_CSPACE = 6 };
     enum { PLAN_WITHDRAW_FROM_OBJECT = 7 };
     enum { PLAN_WITHDRAW_FINE_FROM_OBJECT = 8 };
     enum { PLAN_OBJECT_GRASP = 9 };
     enum { CART_MOVE_CURRENT_TO_CART_GOAL = 10 };
     enum { GRAB_OBJECT = 101 };
     enum { DROPOFF_OBJECT = 102 };
     enum { STRADDLE_OBJECT = 103 };
     enum { SET_SPEED_FACTOR = 10 };
     enum { DEFAULT_GRASP_STRATEGY = 0 };
     enum { EXECUTE_PLANNED_MOVE = 100 };
     enum { GRIPPER_PREPARE_GRASP_OBJECT = 20 };
     enum { GRIPPER_GRASP_OBJECT = 21 };
     enum { GRIPPER_RELEASE_OBJECT = 22 };
     enum { GRIPPER_IS_OBJECT_GRASPED = 23 };
