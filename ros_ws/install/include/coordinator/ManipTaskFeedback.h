...
struct ManipTaskFeedback_
{
  ...
  _feedback_status_type feedback_status;
    ...
    enum { RECEIVED_NEW_TASK = 0 };
     enum { PERCEPTION_BUSY = 1 };
     enum { PICKUP_PLANNING_BUSY = 2 };
     enum { PICKUP_MOTION_BUSY = 3 };
     enum { PICKUP_SUCCESSFUL = 103 };
     enum { DROPOFF_PLANNING_BUSY = 4 };
     enum { DROPOFF_MOTION_BUSY = 5 };
     enum { NO_CURRENT_TASK = 6 };
     enum { ABORTED = 7 };
     enum { COMPLETED_MOVE = 8 };
     enum { COMPLETED_DROPOFF = 9 };
     enum { PREPOSE_MOVE_BUSY = 10 };
     enum { MOVE_BUSY = 11 };
